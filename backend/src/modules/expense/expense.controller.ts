...
import { CreateExpenseDto, CreateExpenseCategoryDto } from './expense.dto';
...
export class ExpenseController {
  ...
  @Post('categories') addCategory(@CurrentUser() u: any, @Body() dto: CreateExpenseCategoryDto) {
    return this.svc.addCategory(u.tenant_id, dto.name);
  }
