...
INSERT INTO `package` (id, name, slug, description, price_monthly, price_yearly, is_active, is_popular, sort_order) VALUES
(1, 'Starter',    'starter',    'Basic POS and inventory',        2999.00,  29990.00,  1, 0, 1),
(2, 'Pro',        'pro',        'Full featured shop management',  4999.00,  49990.00,  1, 1, 2),
(3, 'Enterprise', 'enterprise', 'Multi-user with analytics',      9999.00,  99990.00,  1, 0, 3);
...
(3,  2, 'pos',       'active', 3, 'yearly',  '2024-01-15', '2025-01-15', 'paid'),
(4,  2, 'inventory', 'active', 3, 'yearly',  '2024-01-15', '2025-01-15', 'paid'),
(5,  3, 'pos',       'active', 1, 'monthly', '2024-02-01', '2025-02-01', 'paid'),
(6,  3, 'inventory', 'active', 1, 'monthly', '2024-02-01', '2025-02-01', 'paid'),
(7,  4, 'pos',       'active', 2, 'yearly',  '2024-02-20', '2025-02-20', 'paid'),
(8,  4, 'inventory', 'active', 2, 'yearly',  '2024-02-20', '2025-02-20', 'paid'),
(9,  5, 'pos',       'active', 3, 'monthly', '2024-03-05', '2025-03-05', 'paid'),
(10, 5, 'inventory', 'active', 3, 'monthly', '2024-03-05', '2025-03-05', 'paid');
